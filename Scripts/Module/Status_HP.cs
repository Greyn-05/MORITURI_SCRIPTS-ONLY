...
public class Status_HP : BaseStatus_Max
{
    
    #region Init
    public Status_HP(float setValue) : base(setValue) { }
    public Status_HP(float curValue, float maxValue) : base(curValue, maxValue) { }
    #endregion
